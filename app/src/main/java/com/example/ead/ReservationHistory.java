...
public class ReservationHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rList = findViewById(R.id.HVMrecycler);

        ReservationList = new ArrayList<>();
        adapter = new HistoryAdapter(getApplicationContext(),ReservationList);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent goBack = new Intent(ReservationHistory.this,Dashboard.class);
